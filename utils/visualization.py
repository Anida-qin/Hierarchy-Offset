...
def draw_sequences(i, k, step, action, draw, region_image, background, path_testing_folder, iou, reward,
    ...
    :param i: epoch id
    :param k: class kth object
    :param step: step for finding one object in one image
    :param action:
    :param draw:
    :param region_image: image already been cropped
    :param background:
    :param path_testing_folder: image path for saving
    :param iou: iou of this region bbox of ground truth box
    :param reward: reward of this action
    :param gt_mask: ground truth mask with shape of original image
    :param region_mask: region mask with shape of original image
    :param image_name:
    :param save_boolean:
    :return:
    '''
